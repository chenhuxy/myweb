...
urlpatterns = [
    ...
    path('index/table/user/del-all/', account.user_del_all, ),
    path('index/table/user/resetPwd/', account.reset_password, ),
    path('index/table/usergroup/del/', account.usergroup_del, ),
    path('index/table/usergroup/del-all/', account.usergroup_del_all, ),
    ...
    path('index/wf/wftype/del-all/', workflow.wftype_del_all, ),
    ...
    path('index/wf/wfbusiness/del-all/', workflow.wfbusiness_del_all, ),
    ...
    path('index/deploy/scripttype/del-all/', deploy.deploy_script_type_del_all, ),
    ...
    path('index/deploy/app/del-all/', deploy.deploy_app_del_all, ),
    ...
    path('index/assets/env-type/del-all/', assets.env_type_del_all),
    ...
    path('index/assets/os-type/del-all/', assets.os_type_del_all),
    ...
    path('index/assets/device-type/del-all/', assets.device_type_del_all),
    ...
    path('index/assets/device-status/del-all/', assets.device_status_del_all),
    ...
    path('index/assets/idc/del-all/', assets.idc_del_all),
    ...
    path('index/assets/tag/del-all/', assets.tag_del_all),
    ...
    path('index/assets/asset/del-all/', assets.asset_del_all),
