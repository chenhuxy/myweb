# Generated by Django 2.2.17 on 2021-04-26 16:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('0', 'shell'), ('1', 'python')], default='0', max_length=200, verbose_name='脚本类型')),
            ],
            options={
                'verbose_name': '脚本类型',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, verbose_name='备注')),
                ('creater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.UserProfile')),
            ],
            options={
                'verbose_name': '操作日志',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('contact', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='myapp.UserProfile')),
            ],
            options={
                'verbose_name': '业务线',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deployment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.act_re_deployment', verbose_name='部署id')),
            ],
        ),
    ]
